  ...
  return (
    <section id="members" className="py-24 bg-gradient-to-b from-blue-marinho to-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-5xl md:text-7xl font-black text-center uppercase tracking-tighter mb-20 font-sans">
          Integrantes
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 justify-items-center">
